...
<!--									<li>
				...
				<div class=" col-sm-6 col-md-4 col-md-offset-1">
					<div class="vcard">
						<h1>Adress &amp; Phone</h1>
						<p class="adr">
							<span class="company-name">Barnelli Cafe &amp; Restaurnt</span>
							<span class="street-address">Zdrowa 18</span>
							<span class="postal-code">53-511 Wrocław</span>
						</p>
						<p>
							<span class="email">email: <a class="email" href="mailto:lavenda@cafe.com" title="">lavenda@cafe.com</a></span>
							<span class="tel">mobile: <span>+48 122 33 66</span></span>
						</p>
					</div>	
				</div>	
