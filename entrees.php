	...
	<div id="second-menu" class="menu padding-wrapper">
		<div class="container animate-in animate-in-fade">
			<header class="row">
				<div class="col-md-12">
					<div class="menu-header">
						<h2><span>Entrees: Veg <i class="fa fa-lemon-o"></i></span></h2>
					</div>
				</div>
			</header>
			<section class="row">
			...
			<header class="row">
				<div class="col-md-12">
					<div class="menu-header">
						<h2><span>Entrees: Non Veg <i class="fa fa-lemon-o"></i></span></h2>
					</div>
				</div>
			</header>                    
			<section class="row">
			...
			<section class="row">
				<div class="menu-list col-md-4">
					<article class="menu-item">
								<p class="title">15- BARRA KEBAB</span></p>
								<p class="description">lamb cutlets marinated with authentic indian spices & cooked in clay oven</p>
						<div class="price">
							<span>16,50</span>
						</div>
					</article>
